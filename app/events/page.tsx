...
export default function EventsPage() {
    return (
        <div className="bg-gradient-to-b from-background via-red-50/10 to-background py-24 sm:py-32 min-h-screen">
                    ...
                    <StaggerContainer className="space-y-8" staggerDelay={0.1}>
                        {events.map((event, index) => (
                            <StaggerItem key={event.id}>
                                ...
                                >
                                    <div className="absolute inset-0 bg-jaali opacity-[0.02] pointer-events-none" />
                                    ...
                                    <div className="lg:w-1/4 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-border pb-4 lg:pb-0 lg:pr-8 pl-4 lg:pl-6">
                                        <motion.div
                                    ...
                                    <div className="lg:w-3/4 lg:pl-4">
                                        <h3 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl font-serif group-hover:text-primary transition-colors">
                                            {event.title}
                                        </h3>
