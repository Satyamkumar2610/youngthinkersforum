...
const categories = ["All", "Policy", "History", "Culture", "Economics", "Philosophy"];
                        ...
                        {filteredPosts.map((article, index) => (
                            ...
                            >
                                ...
                                >
                                    {/* Image Container */}
                                    <motion.div
                                        className="relative aspect-[16/10] sm:aspect-[2/1] lg:aspect-[3/2] overflow-hidden bg-gray-100"
                                        whileHover={{ scale: 1.02 }}
                                    >
                                        <motion.img
                                            src={article.imageUrl || `/api/placeholder/600/400?text=${encodeURIComponent(article.title)}`}
                                            alt={article.title}
                                    ...
                                    <div className="flex flex-col flex-grow p-6 bg-white">
                                        ...
                                        {/* Title */}
                                        <h3 className="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-primary transition-colors font-serif line-clamp-2">
                                            {article.title}
                                        </h3>

                                        {/* Excerpt */}
                                        <p className="mt-3 line-clamp-3 text-sm leading-6 text-gray-600 flex-grow">
                                            {article.excerpt}
                                        </p>
                                        ...
                                        <div className="mt-6 flex items-center gap-x-4 border-t border-gray-100 pt-4">
                                            <motion.div
                                                className="h-10 w-10 rounded-full bg-gradient-to-br from-red-50 to-red-100/50 flex items-center justify-center font-semibold text-primary text-sm ring-2 ring-white shadow-sm"
