            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-12 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {events.map((event, index) => (
                        <ScrollReveal key={event.id} delay={index * 0.2} width="100%">
                            <div
                                className="flex flex-col items-start justify-between bg-white/50 border border-white/60 p-6 rounded-xl transition-all duration-500 group relative overflow-hidden backdrop-blur-sm hover:bg-white h-full"
