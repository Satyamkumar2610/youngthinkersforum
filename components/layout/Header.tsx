    ...
    return (
        <header
            className={cn(
                ...
                isScrolled ? "bg-white/95 backdrop-blur-sm shadow-sm border-gray-100" : "bg-white"
            )}
        >
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <Link href="/" className="-m-1.5 p-1.5 font-serif text-2xl font-bold text-primary tracking-tight">
            ...
            {/* Mobile menu */}
            <div className={cn("lg:hidden", mobileMenuOpen ? "fixed inset-0 z-50 bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 overflow-y-auto" : "hidden")}>
                <div className="flex items-center justify-between">
                    <Link href="/" className="-m-1.5 p-1.5 font-serif text-xl font-bold text-primary">
                        YTF
                    </Link>
                    <button
                        type="button"
